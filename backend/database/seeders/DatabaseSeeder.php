...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $edukasis = [
            ...
            [
                'slug' => 'gizi-balita-dan-anak-sehat',
                'title' => 'Panduan Gizi Balita & Anak untuk Tumbuh Kembang Optimal',
                'category' => 'stunting-gizi',
                'excerpt' => 'Kebutuhan nutrisi makro & mikro seimbang untuk mendukung perkembangan fisik dan kognitif balita.',
                'content' => 'Gizi seimbang bagi balita terdiri dari karbohidrat, protein hewani (ikan kembung, telur, ayam), lemak sehat, serta buah & sayur. Rutin berikan suplemen Vitamin A dari Posyandu desa dua kali setahun.',
            ],
            [
                'slug' => 'layanan-posyandu-dan-pencatatan-kms',
                'title' => 'Layanan Posyandu & Pemantauan Grafik KMS Balita',
                'category' => 'stunting-gizi',
                'excerpt' => 'Pentingnya penimbangan rutin dan pencatatan KMS balita setiap bulan di Posyandu Desa Karangpapak.',
                'content' => 'Posyandu hadir sebagai sarana pemantauan tumbuh kembang anak. Penimbangan rutin, pengamatan grafik KMS, imunisasi berkala, dan konsultasi gizi bersama bidan desa menjadi langkah deteksi awal cegah stunting.',
            ],
            [
                'slug' => 'periode-emas-1000-hpk-balita',
                'title' => 'Mengawal 1000 Hari Pertama Kehidupan Cegah Stunting',
                'category' => 'stunting-gizi',
                'excerpt' => 'Fase 270 hari dalam kandungan hingga anak berusia 2 tahun sebagai penentu masa depan anak.',
                'content' => '80% pembentukan organ vital dan otak anak terjadi pada periode 1000 HPK. Pola makan seimbang ibu hamil, ASI Eksklusif 6 bulan, dan MPASI kaya protein hewani memastikan anak tumbuh sehat dan cerdas.',
            ],
            [
                'slug' => 'kebun-edukasi-pembibitan-dan-biochar',
                'title' => 'Kebun Edukasi: Inovasi Biochar & Pembibitan Tani Unggul',
                'category' => 'kebun-edukasi',
                'excerpt' => 'Pusat inovasi pertanian terpadu berbasis pemanfaatan Biochar untuk penyuburan lahan tani warga Karangpapak.',
                'content' => 'Kebun Edukasi Tani Desa Karangpapak menerapkan teknologi arang hayati (Biochar) yang dikombinasikan dengan pupuk kompos organik. Program ini bertujuan meningkatkan daya ikat air tanah pesisir, memperbaiki struktur tanah, serta mempercepat pembibitan komoditas unggulan lokal.',
            ],
            [
                'slug' => 'budidaya-tanaman-organik-dan-hidroponik',
                'title' => 'Panduan Budidaya Tanaman Organik & Sayuran Hidroponik',
                'category' => 'kebun-edukasi',
                'excerpt' => 'Pelatihan teknik penanaman sayur organik hemat lahan untuk ketahanan pangan keluarga.',
                'content' => 'Budidaya sayuran hidroponik dan tanaman organik ramah lingkungan memanfaatkan pekarangan rumah. Selain menghemat biaya belanja sayur harian, hasil panen bebas pestisida kimia ini sangat mendukung gizi keluarga dan pencegahan stunting balita.',
            ],
            [
                'slug' => 'resep-mpasi-bahan-lokal',
                'title' => 'Resep MPASI Bergizi Berbahan Pangan Lokal',
